...
const GuideFaq = () => {
  const faqList = [
    ...
    },
    {
      ...
      content: [
        `⌨ 답변을 원하는 질문의 페이지로 이동하면, 질문 페이지 내용의 하단에 답글을 작성할 수 있는 [ 텍스트 에디터 ]가 준비되어 있습니다. 단순한 텍스트 입력뿐만 아니라, [ 볼드 / 이탤릭체 | 밑줄긋기 | 컬러 하이라이팅 | 링크 붙이기 ] 등의 스타일 작업 후에 답글을 올릴 수 있습니다. 업로드한 답글은 답글 목록의 최상단으로 배치됩니다!`,
      ],
    },
    {
